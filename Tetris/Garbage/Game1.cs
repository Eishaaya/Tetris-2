...
namespace Tetris
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            grid = new Grid(new Vector2(10, 20), Gimage, locations, symmetry, colors, chances, vals, diffs, sizes, image, turnEffect, landEffect, boomEffect, speedEffect, bossEffect, Content.Load<Texture2D>("ShadowImage"), .6667f, false, Content.Load<Texture2D>("TileCover"), Content.Load<Texture2D>("Explosive"), Content.Load<Texture2D>("Speeder Tile"), Content.Load<Texture2D>("Pixel"), Content.Load<Texture2D>("Speed Particle"));
